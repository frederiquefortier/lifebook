...
is not a single book but a **system** that preserves the data, analyzes it, and can
...
- Not censorship of sensitive content — the goal is informed reader consent, not removal.
...
- **The Loved One** (invited reader) — family, partner, or friend reading the finished
  book. Holds the printed snapshot, not the system. Shapes the *reading experience*
